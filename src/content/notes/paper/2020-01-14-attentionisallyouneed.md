...
![HeadImg](https://lh3.googleusercontent.com/d/1si3KMBjwZJ3inzTuoeUUsl7mutbDLNbz)

*[그림 1] RNN의 forward propagation*
...
$$
![HeadImg](https://lh3.googleusercontent.com/d/15FPAUru5Rm1x3LUu6pcSjaZiuRrBkj97)

*[그림 2] 모델구조: Encoder(좌), Decoder(우)*
...
![HeadImg](https://lh3.googleusercontent.com/d/14tFq4-RDEDFbc9vEABWqiFxG0pI4qq3G)

*[그림 3] 기계번역 문제로 Q, K-V 의 관계 알아보기*
...
![HeadImg](https://lh3.googleusercontent.com/d/1vFw0wuulHhzu5kwZLQ1QStl24KjnlsgX)

*[그림 4] 감성 분류 문제를 통해 Self-Attention 에 대해 알아보기*
...
$$
![HeadImg](https://lh3.googleusercontent.com/d/1CtBsDHkyU8hmFj2MB0IDhEQO7wCKUEkM)

*[그림 5] Q, K, V크기를 표기한 Scaled-Dot Product Attention*
...
![HeadImg](https://lh3.googleusercontent.com/d/1jpQdv3lFrYNRZ5FbCvcXF4RDtpho0og_)

*[그림 6] Multi-Head Attention*
...
![HeadImg](https://lh3.googleusercontent.com/d/1IznpVENdNpwyKqJCD0mWnZRcQ2XaIh22)

*[그림 7] 최대 길이가 51인 Positional Encoding Table*
...
![HeadImg](https://lh3.googleusercontent.com/d/1VnSx8Ct5_NNNoa13zGfA5p-RSgbzBIMn)

*[그림 8] Decoder Sub-sequence Attention Masking*
2. 실제 토큰의 길이
...
![HeadImg](https://lh3.googleusercontent.com/d/1KOJA8DNlTQjnKb19zn2vRtzEIRbB8Ut2)

*[그림 9] 실제 토큰 길이에 대한 Masking*
...
![HeadImg](https://lh3.googleusercontent.com/d/1d0xw7_xjr1rv7-SjuxQKRmML4oio561j)

*[그림 10] hidden 크기 및 warmup steps 에 따른 학습률의 변화*
...
![HeadImg](https://lh3.googleusercontent.com/d/1HsVRsp3mMjo8UBSTU81ZE4i_MUZ4Z1Xa)

*[그림 11] Multi30k 성능 테스트*
<!-- References -->
