...
!!! info "random-sample one-step tabular Q-planning"
    ...
    === "pseudo code"
![HeadImg](https://lh3.googleusercontent.com/d/1B5ouTXjMSO0A2wJxkFeHP2UPL67MYe-E)
...
|Dyna |General Dyna| 
|:-:|:-:|
| ![HeadImg](https://lh3.googleusercontent.com/d/1BHRiar1J0oJMe0ZrHF9pKFO54I_7jPPp) | ![HeadImg](https://lh3.googleusercontent.com/d/1BMxCdEq2dTAnaD6dOgg1JwLWVJjSE0Qi) |
...
!!! info "Tabular Dyna-Q"
    ...
    === "pseudo code"
![HeadImg](https://lh3.googleusercontent.com/d/1BOyzRDso-Lw8HrBjBIlxIhbH0YJL1Pb4)

        * 여기서 (e) 와 (f) 과정이 없으면 one-step tabular Q-learning과 동일하다.


!!! note "Dyna Maze"
![HeadImg](https://lh3.googleusercontent.com/d/1BXGoERyTg6R1Q1YURb2rVxhCXFRIowd7)
...
![HeadImg](https://lh3.googleusercontent.com/d/1BXQ7GQ__7ov2V_7RAP48kf6RRMRUOCfc)
...
!!! note "Example: Blocking and Shorcut Maze"
    ...
    === "Blocking Maze" 
![HeadImg](https://lh3.googleusercontent.com/d/1BZ_NWxjrRoukE0kaZ1X7vKl3OgksSsAO)

간단한 미로이지만 1000 time steps 이후에 장벽으로 생긴 블록이 오른쪽으로 한칸 이동한다. 처음에 최적의 경로는 오른쪽으로 탐색하는 것이고 블록이 옮겨지면 왼쪽으로 찾는 것이 최적의 경로다. 

=== "Shortcut Maze" 
![HeadImg](https://lh3.googleusercontent.com/d/1BgPlwrHxWAv-Eni7UvGx0qO2Nrpk9tf3)
...
!!! info "Prioritized Sweeping"
    ...
    === "pseudo code"
![HeadImg](https://lh3.googleusercontent.com/d/1BilaMm2xjjYc6AWijbrjXY1EVuQ0rYFT)
...
![HeadImg](https://lh3.googleusercontent.com/d/1BkvoAyyvO4KUHRdyH0fZ8fJha6Nqylvj)
...
![HeadImg](https://lh3.googleusercontent.com/d/1BlzjFO8mWgLr1wGgxZ6CYEWVOiwf6PIf)
...
![HeadImg](https://lh3.googleusercontent.com/d/1BnBuyRV43vfqBuWsBHqsEGhf-0zhOn8-)
...
!!! note "MCTS Illustration"
    ...
    === "Illustration"
![HeadImg](https://lh3.googleusercontent.com/d/1BuR89m2TSROMwCo9FjUAjMWBUPUFbl9X)
...
![HeadImg](https://lh3.googleusercontent.com/d/1C3ETh5IGNWgjJ4_HfZdAS4RAm4W1NJ-W)
![HeadImg](https://lh3.googleusercontent.com/d/1C8xzduGqj2YbjIE-ldjjoXT0NnC2BSgj)
![HeadImg](https://lh3.googleusercontent.com/d/1CHVeW_dV2dCXMoTAKV02xe-paUSIlNPc)
