...
---
![HeadImg](https://lh3.googleusercontent.com/d/1rVmsigPLPnvqh-1YweLmepy4iiR3H0Dk)

*Reference: Google Big Query*
...
=== "Create Dataset 1"
![Image title](https://lh3.googleusercontent.com/d/1ZGhm1twS9bn2WNUYBvJLePx3nRRUMSp3)

    프로젝트 ID에서 데이터 세트를 만든다.

=== "Create Dataset 2"
![Image title](https://lh3.googleusercontent.com/d/1K1j0MkcYfIDurmG2ikDviM_0O0815XhQ)

    데이터 세트 ID `titanic`를 입력한다. 데이터 세트가 생성되고나면 에셋이 생성 되었다는 문구가 뜬다.
![Image title](https://lh3.googleusercontent.com/d/1xsGTsh-m12E8DBdfvzCp7sGgkKY2c3eZ)
...
=== "Create Table 1"
![Image title](https://lh3.googleusercontent.com/d/1niATIQ_ibXPTIoFdIx4nSJIVIqxmhIZL)

    `업로드`를 통해서 소스 파일을 테이블로 만들자. 스키마는 직접 설정하거나 자동으로 감지하여 생성할 수 있다.

=== "Create Table 2"
![Image title](https://lh3.googleusercontent.com/d/1yvw1eKNlxL3knao6I7Ic9fnLg_qtSfRC)
...
![Image title](https://lh3.googleusercontent.com/d/1AQWIhi5aw_AgfR5bw7k_nwCVR1NNASx_)
...
![Image title](https://lh3.googleusercontent.com/d/1a4YylPF-V3DnZM5ta5QoLlGiHAjdF9k0)

그리고 `titanic_model`를 클릭하여 평가 항목을 살펴보면 모델의 평가 데이터로 평가된 결과를 볼 수 있다. 
![Image title](https://lh3.googleusercontent.com/d/1fsGNURF6214AhTGDO4Rrx0HvViY4C3a9)
...
![Image title](https://lh3.googleusercontent.com/d/1Q9Jezc00RzMkQqC3u5ZMPztcdgNqeZrJ)
