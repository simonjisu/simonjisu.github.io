...
![Image title](https://lh3.googleusercontent.com/d/19N7VANFTk-YNqfNGi16NJhcOEGqgNowb)
...
![Image title](https://www.noaa.gov/sites/default/files/2022-11//ll_quadwind_soln5.png)
...
!!! info "설정"
    ...
    === "fillColor"
![Image title](https://lh3.googleusercontent.com/d/19R4YTCWSw7GbQA5z7wqJ88r5ICuPSOqS)

    === "fillOpacity"
![Image title](https://lh3.googleusercontent.com/d/19UI6-JHAGc0YqU9OkVz_1bNcxDg0UsvL)

    === "circleRadius"
![Image title](https://lh3.googleusercontent.com/d/19RES057I0jjPzi5GY2BnlVhIo1_xLAZp)
...
!!! info "설정"
    ...
    === "fillColor"
![Image title](https://lh3.googleusercontent.com/d/19sk0mFPKCWNlR4l5FOQs-un4TnqEUyxz)

        각 카테고리는 서울시 자치구역 통합 계획에 따라 부여했다. 
![Image title](https://lh3.googleusercontent.com/d/19zn8qnF8PgFe5iw_lbrbXu8lxFqX_L_x)

    === "fillOpacity"
![Image title](https://lh3.googleusercontent.com/d/19sLrIOmItqEqU9CzQgLQVSV18JgIkKtp)

    === "circleRadius"
![Image title](https://lh3.googleusercontent.com/d/19sywjCFLpbUH6dyTq2Pi7wRkopqRz3Lz)

### 최종 시각화 결과물

꼭 구글로 써야한다면 해당 툴을 쓰지만 조금 더 자유롭게 하려면 Python의 Folium 패키지 등 다른 툴을 쓰는 것이 좋아보인다.
![Image title](https://lh3.googleusercontent.com/d/19YzCpliuViyYzOhOW99eCiXbbGKuP4wG)