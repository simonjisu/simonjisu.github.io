...
![HeadImg](https://lh3.googleusercontent.com/d/1_yVeByCLoQFce2pSICQAa5BqMahRZY5T)

*Binary symmetric Channel: 하나의 비트를 송수신 하는 채널.*
$$
\begin{aligned}
P(y=0 \vert x=0) &= 1 - f & 
P(y=0 \vert x=1) &= f \\
...
![HeadImg](https://lh3.googleusercontent.com/d/1eAtNmPENLmN7yEWQsLuCk2lueKZu4MLn)
